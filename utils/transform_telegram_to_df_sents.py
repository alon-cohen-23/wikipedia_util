...
def convert_yonathan_languages_col_format_to_df_sents(data_folder):
    df = pd.read_parquet(r"D:\NLP\Translation\wikipedia_util\data\raw\telegram\translation_dataset_v1.parquet")
    ...
    df.to_parquet(data_folder / 'translation_yonatan_sents_ar_en.parquet')
